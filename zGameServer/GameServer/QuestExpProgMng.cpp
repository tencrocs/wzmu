                                        ...
                                        int obj_index)
{
    ...
    for(int x = 0; x < INVENTORY_SIZE; ++x )
    {
        ...
        if( ((gObj[obj_index].pInventory[x].m_Type > 7324 || gObj[obj_index].pInventory[x].m_Type < 7321) 
			&&gObj[obj_index].pInventory[x].m_Type < 7168 || gObj[obj_index].pInventory[x].m_Type > 7176)
                                                ...
                                                OBJECTSTRUCT *lpMonsterObj)
{
    ...
    for(int i = 0; i < 25; ++i )
    {
       ...
       // QuestDropItemInfo* quest_drop_item_info = g_QuestExpManager.GetQuestDropItemInfo(quest_switch);//check for bugs
