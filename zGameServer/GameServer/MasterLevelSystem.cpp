...
void CMasterLevelSystem::LoadData()	//OK
{
	...
	// ----
	this->m_MaxMasterLevel = GetPrivateProfileInt("Common", "MaxMasterLevel", 200, gDirPath.GetNewPath("MasterSystem.cfg"));
	this->m_MaxMasterPoints = GetPrivateProfileInt("Common", "MaxMasterPoints", 200, gDirPath.GetNewPath("MasterSystem.cfg"));
